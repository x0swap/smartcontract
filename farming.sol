...
contract Farming is Ownable {
    ...
    uint256[4] public periodInBlocks;
    ...
    constructor(
        ...
        for(uint256 i=0; i<4; ++i){
            periodInBlocks[i] = periodInDays[i]*dayInBlocks;
        }
    }
    ...
    function deposit(uint256 _pid, uint256 _fpid, uint256 _amount) public {
        ...
        user.userPeriod[_fpid].depositBlock = block.number;
        user.userPeriod[_fpid].withdrawBlock = user.userPeriod[_fpid].depositBlock + periodInBlocks[_fpid];
