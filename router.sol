...
contract UniswapV2Router02 is Initializable, ContextUpgradeSafe, OwnableUpgradeSafe, IUniswapV2Router02 {
    using SafeMath for uint;
    ...
    function __UniswapV2Router_init(address _factory, address _WETH) public initializer {
        __UniswapV2Router_init_unchained(_factory, _WETH);
    }

    function __UniswapV2Router_init_unchained(address _factory, address _WETH) internal initializer{
        __Ownable_init_unchained();
        factory = _factory;
        WETH = _WETH;
    }
